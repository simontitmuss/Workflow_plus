function [stitchedPhase, stitchedYFP] = stitchImagesPhaseOneGFP(startImageFolder, nCols, nRows, nTime, imSize, offsetCol, offsetRow)
...
%initilize arrays;
    ...
    for j = 1:size(strs, 1)    
        ...
        imagesYFP = imageArray_v2([strs(j).folder '\' tmpName],'GFP');
